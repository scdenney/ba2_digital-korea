...
| 11 (Final Assessment) | *Kyongje Yongu* (KJYG) sample | 360 articles from the DPRK economics journal, 1987–2017, balanced 120 per leader era (Kim Il-sung / Kim Jong-il / Kim Jong-un). See the [data dictionary](week11_assessment/data_dictionary.html). | <a href="week11_assessment/dataset1_kjyg_sample.csv" download>CSV</a> (~3.1 MB) |
| 11 (Final Assessment) | Cheong Wa Dae Petitions sample | 360 citizen petitions from the Cheong Wa Dae online platform, 2017–2018, balanced 60 per category (정치개혁 / 인권·성평등 / 외교·통일·국방 / 육아·교육 / 보건복지 / 일자리). See the [data dictionary](week11_assessment/data_dictionary.html). | <a href="week11_assessment/dataset2_bluehouse_petitions_sample.csv" download>CSV</a> (~600 KB) |
