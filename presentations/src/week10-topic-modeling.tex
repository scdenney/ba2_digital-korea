...
\begin{frame}{The Topic Modelling Widget in Orange}{Input a Corpus, pick a method, set $k$, read topics out the other side}
  \begin{columns}[T, onlytextwidth]
    \column{0.48\textwidth}
      ...
      \end{itemize}
    \column{0.48\textwidth}
      \textbf{What you set for LDA}
      \begin{itemize}
        \item \texttt{Number of topics}: the $k$ you pick (default 10)
        \item \emph{That's it.} Alpha, eta, iterations, seed are fixed at gensim defaults
